        ...
        {selectedProject && (
          ...
          >
            ...
            <motion.div
              ...
              style={{ willChange: 'transform, opacity' }}
              className="relative w-full h-full md:h-auto md:max-w-6xl md:max-h-[85vh] bg-zinc-950 md:bg-zinc-900 md:rounded-[2.5rem] overflow-y-auto md:overflow-hidden flex flex-col md:flex-row shadow-2xl md:border border-white/10"
            >
              <button
                ref={closeButtonRef}
                onClick={closeModal}
